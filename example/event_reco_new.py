...
PATH_TO_INPUT = '/home/mjansson/data/TP_ftr_from_babu/' 
...
N_SPLITS = 100 # number of batches
...
if ni == 'f64':
    ...
    eval_network_v = get_network_eval_v_fn(bpath=modelpath, dtype=dtype, n_hidden=n_hidden)
else:
    ni = "f32"
...
plot_event(event_data, EVENT_INDEX, geo=geo,outfile=f'{ni}_eventplot_{EVENT_INDEX}.png')
...
plt.savefig(f"new_{ni}_scan_ev_{EVENT_INDEX}_corrected.png", dpi=300)
plt.show()