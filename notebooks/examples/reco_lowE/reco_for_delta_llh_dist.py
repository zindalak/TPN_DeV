...
for event_id in event_ids:
    ...
    bp = '/home/storage2/hans/i3files/lowE/tfrecord/'
    tfrecord = os.path.join(bp, f'data_ds_event_{event_id}_from_0_to_10_1st_pulse.tfrecord')
    #if not os.path.exists(f'/home/storage2/hans/i3files/alerts/bfrv2/NN_corrections/tfrecord/data_event_{event_id}_1st_pulse.tfrecord'):
