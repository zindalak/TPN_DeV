...
batch_maker = I3SimBatchHandlerTFRecord(fs, batch_size=16)
...
np.save("reco_result_21217_21220_sigma_3.0_clipcharge200_c_multi_gamma_mpe_prob_midpoint2_v_AND_weighted_noise_splineMPEseed.npy", results)
