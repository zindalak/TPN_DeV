...
batch_size = 100 # let's load all events in one go.
n_bins = 1
...
# store results.
np.save(f"/home/storage/hans/jax_reco_new/examples/reco_realtime/update/reco_result_{event_id}_tfrecord.npy", y)
