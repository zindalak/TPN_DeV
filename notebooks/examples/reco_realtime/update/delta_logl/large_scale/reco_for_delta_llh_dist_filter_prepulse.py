...
for event_id in event_ids:
    ...
    np.save(f"results/filter_prepulse/llh_results_event_{event_id}_padded_input", llh_results)
    np.save(f"results/filter_prepulse/mincoords_event_{event_id}_padded_input", best_x/scale_rad)
    np.save(f"results/filter_prepulse/truecoords_event_{event_id}_padded_input", event_meta_data[:, 2:4])
    np.save(f"results/filter_prepulse/splinempecoords_event_{event_id}_padded_input", event_meta_data[:, 8:10])
