...
from likelihood_mpe_postjitter_w_weighted_noise import get_neg_c_triple_gamma_llh
...
#centered_track_time = centered_track_time - 5.0
...
plt.legend()
plt.tight_layout()
plt.savefig(f"mpe_scan_ev_{event_index}_postjitter_w_weighted_noise.png", dpi=300)
