...
from likelihood_conv_mpe_padded_input import get_neg_c_triple_gamma_llh
...
np.save("reco_result_21217_21220_sigma_3.0_clipcharge20_c_multi_gamma_mpe_prob_midpoint_v.npy", results)
