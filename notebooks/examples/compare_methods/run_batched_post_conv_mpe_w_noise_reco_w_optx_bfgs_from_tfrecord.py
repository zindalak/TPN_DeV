...
for i in range(n_batches):
    try:
        ...
        print("median delta logl", np.median(delta_logl))
...
np.save("reco_result_21217_21220_sigma_3.0_clipcharge20_c_multi_gamma_mpe_prob_midpoint_v_AND_noise.npy", results)
