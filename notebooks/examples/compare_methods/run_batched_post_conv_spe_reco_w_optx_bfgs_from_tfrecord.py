...
from likelihood_conv_spe_padded_input import get_neg_c_triple_gamma_llh
...
np.save("reco_result_21217_21220_sigma_3.0_SPE_c_multi_gamma_spe_prob_v.npy", results)
