...
from likelihood_mpe_padded_input_biweight_conv import get_neg_c_triple_gamma_llh
...
#np.save("reco_result_21220_tfrecord_biweight_conv_1st_pulse_MPE_tsigma_4.0.npy", results)
np.save("reco_result_21217_tfrecord_biweight_conv_1st_pulse_MPE_tsigma_4.0.npy", results)
