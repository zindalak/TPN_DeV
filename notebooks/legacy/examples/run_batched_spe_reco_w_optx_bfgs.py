...
sim_handler = I3SimHandlerFtr(
    os.path.join(bp, 'meta_ds_21217_from_10000_to_20000_1_to_10TeV.ftr'),
...
batch_maker = I3SimBatchHandler(sim_handler, batch_size=4096)
...
np.save("reco_result.npy", results)
