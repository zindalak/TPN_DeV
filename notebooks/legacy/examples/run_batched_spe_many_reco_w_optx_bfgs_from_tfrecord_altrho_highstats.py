...
tfrecord = "/home/storage2/hans/i3files/21220/ftr/data_ds_n_pulses_5_21220_from_*_to_*.tfrecord"
n_pulses = 5
batch_maker = I3SimBatchHandlerTFRecord(tfrecord, batch_size=8192, n_features = 3 + 2*n_pulses)
...
np.save("reco_result_21220_tfrecord_n_pulses5_altrho.npy", results)
